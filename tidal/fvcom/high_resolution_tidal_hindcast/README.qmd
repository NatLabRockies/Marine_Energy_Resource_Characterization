...
characterization. Complete standardized and summarized datasets can downloaded from [Amazon Web
Services Open Data Registry][aws_tidal_docs], and summary data is visualized on the [Marine Energy
Atlas][me_atlas].
...
[aws_tidal_docs]: https://registry.opendata.aws/wpto-pds-us-tidal/
