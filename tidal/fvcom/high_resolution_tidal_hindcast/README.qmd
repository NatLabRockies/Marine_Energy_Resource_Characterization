...
Laboratory][pnnl_resource_char] (PNNL) (data generation) and the [National Renewable Energy
Laboratory][nrel_resource_char] (data processing and visualization), to generate, standardize, and
...
| ---                               | ---            | ---                               |
| Processing Code (This Repository) | In Development | `{python} code['version']`        |
| Public Dataset                    | Not Released   | `{python} dataset['version']`     |
| Working Dataset                   | In Development | `{python} dataset['dev_version']` |
...
[nrel_resource_char]: https://www.nrel.gov/water/resource-characterization
[navd88]: https://en.wikipedia.org/wiki/North_American_Vertical_Datum_of_1988
[this_repo]: https://github.com/NREL/Marine_Energy_Resource_Characterization
